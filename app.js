...
function DrawTheTree(geom, x_init, y_init, z_init){
  ...
  var
    axis_delta = new THREE.Vector3(),
    prev_startpoint = new THREE.Vector3();

  var
    startpoint = new THREE.Vector3(x0,y0,z0),
...
function init() {
  ...
  renderer.setSize( 800, 1200 );
	...
	camera = new THREE.PerspectiveCamera( 45, 800 / 1200, 1, 1000 );
  ...
  line_geometry = DrawTheTree(line_geometry, 0, -300, 0);
